// Live "Home" data contract — mirror of the Worker's HomeData (worker/src/types.ts).
// Fetched from the Worker (`/api/home`) in prod, or a static `/data/home.json` in
// local dev (generated by `npm run build:home:fixture -w worker`).
...
const HOME_URL: string =
  import.meta.env.VITE_HOME_URL || `${import.meta.env.BASE_URL}data/home.json`;
